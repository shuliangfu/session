...
let sessionTranslationsLoaded = false;
...
/**
 * 将 session 文案加载到当前 I18n 实例（仅加载一次）。
 */
export function ensureSessionI18n(): void {
  if (sessionTranslationsLoaded) return;
  ...
  sessionTranslationsLoaded = true;
}
